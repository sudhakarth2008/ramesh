...
public class LicenceAdd
{
	...
	public  void LicenceAdd(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	/*
	 @Test
	 public  void ADD_LiC( )throws Exception
	{  
	AdminLicence A_LiC =new AdminLicence();
	A_LiC.Data_driven_test( );
	}
	 */
		  ...
		  ExcelApiTest3 eat = new ExcelApiTest3();
			// int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Skills.xls","Sheet1");
				 ...
				 {	
					// UserName="ADMIN";
					 //Password="admin123";	 
					 UserName=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Licence.xls","Sheet1",i,0);
					 Password=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Licence.xls","Sheet1",i,1);
					 
					 licence=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Licence.xls","Sheet1",i,2);
	...
	{  
		...
		QS.LicenceAdd(driver, HtmlOutputFileName, TH3);
		
		QS.Licence(iRow, licence);
	...
	public   void Licence(int iRow,String licence)throws Exception
	{  
