...
public class EducationExport
{
	...
	public  void EducationExport(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	/*
	 @Test
	 public  void ADD_EduX( )throws Exception
	{  
	AdminEducationExport AEX =new AdminEducationExport();
	AEX.Data_driven_test( );
	}
	 */
	...
	@Test
	public  void ExportAllEducation( )throws Exception
	{  
			...
			// ExcelApiTest3 eat = new ExcelApiTest3();
			 //int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet1");
				 ...
				 public void call_allmethods(int iRow )throws Exception
					...
					HtmlOutputFileName=TH3.CretaeHTMLFile("TC03_Education","Chrome");
						...
						EX.EducationExport(driver, HtmlOutputFileName, TH3);						
						EX.ExportEducation_();
						TH3.HTMLScreenShot("Export Education Details","Education Details exported to \"C://HTML Report//OrangeHRM6//TC01_ALE.xls\",\"Sheet5\",i,k,\"Blank Data\"","Pass", HtmlOutputFileName,driver);
					...
					public  void ExportEducation_()throws Exception
					{ 
								    	  ...
								    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
								    	   {
								    	        ...
								    	        if (valueIneed1 !=null)
								    	        {
								    	        	...
								    	        	eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet5",i,k,valueIneed1);
								    	        }
								    	       // eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet5",i,k,valueIneed1);
								    	        else
								    	        {
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet5",i,k,"Blank Data");
								    	        }
								    	   }
								    }
