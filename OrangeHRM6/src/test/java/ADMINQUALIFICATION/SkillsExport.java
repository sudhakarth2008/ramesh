...
public class SkillsExport
{
	...
	public  void ExportSkills(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	/*
	 @Test
	 public  void ExportSkills( )throws Exception
	{  
	ExportSkills A_SK_X =new ExportSkills();
	A_SK_X.Data_driven_test( );
	}
	 */
			 ...
			 //int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Skills.xls","Sheet1");
				 ...
				 public void call_allmethods(int iRow )throws Exception
					...
					HtmlOutputFileName=TH3.CretaeHTMLFile("TC01_Export_Employees","Chrome");
						...
						ES.ExportSkills(driver, HtmlOutputFileName, TH3);						
						ES.SkillsExport();
					...
					public  void SkillsExport()throws Exception
					{ 
