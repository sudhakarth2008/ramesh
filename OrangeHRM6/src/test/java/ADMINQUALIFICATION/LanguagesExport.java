...
openurL
login
Admin_Languages_Export
logout
*/


 
public class LanguagesExport
{
	...
	public  void LanguagesExport(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	/*
	 @Test
	 public  void ADD_LanX( )throws Exception
	{  
	AdminLanguagesExport A_L_X =new AdminLanguagesExport();
	A_L_X.Data_driven_test( );
	}
	 */
	...
	@Test
	public  void ExportAllLanguages( )throws Exception
	{  
			...
			// ExcelApiTest3 eat = new ExcelApiTest3();
			 //int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Languages.xls","Sheet1");
				 ...
				 public void call_allmethods(int iRow )throws Exception
					...
					HtmlOutputFileName=TH3.CretaeHTMLFile("TC03_Languages","Chrome");
						...
						LanguagesExport ES=new  LanguagesExport();	
						ES.LanguagesExport(driver, HtmlOutputFileName, TH3);						
						ES.Languages();
								    	  ...
								    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
								    	   {
								    	        ...
								    	        if (valueIneed1 !=null)
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Languages.xls","Sheet5",i,k,valueIneed1);
								    	        else
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Languages.xls","Sheet5",i,k,"Blank Data");
