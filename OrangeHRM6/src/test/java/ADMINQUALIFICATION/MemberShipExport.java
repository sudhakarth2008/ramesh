...
public class MemberShipExport
{
	...
	public  void MemberShipExport(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	@Test
	public  void ExportMemberShip( )throws Exception
	{  
			...
			// ExcelApiTest3 eat = new ExcelApiTest3();
			 //int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Skills.xls","Sheet1");
				 ...
				 public void call_allmethods(int iRow )throws Exception
					...
					HtmlOutputFileName=TH3.CretaeHTMLFile("TC03_Membership","Chrome");
						...
						MemberShipExport EX=new  MemberShipExport();	
						EX.MemberShipExport(driver, HtmlOutputFileName, TH3);						
						EX.ExportMembership();
								    	  ...
								    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
								    	   {
								    	        ...
								    	        if (valueIneed1 !=null)
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Membership.xls","Sheet5",i,k,valueIneed1);
								    	        else
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC03_Membership.xls","Sheet5",i,k,"Blank Data");
