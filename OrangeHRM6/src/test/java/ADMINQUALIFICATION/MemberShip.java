...
public class MemberShip
{
	...
	public  void MemberShip(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	{  	
		MembershipAdd AM=new MembershipAdd();
		AM.Data_driven_test();
	}
	@Test(priority=2)
	public  void ExpoMem( )throws Exception
	{  	
	...
	{  
		...
		HtmlOutputFileName=TH3.CretaeHTMLFile("TC03_Skills1" + str,"Chrome");
		...
		if (iRow==1)
		{
			...
			TH3.HTMLScreenShot("user Name and Password","User Name and password Succefully Entered",
		...
		MBS.MemberShip(driver, HtmlOutputFileName, TH3);
