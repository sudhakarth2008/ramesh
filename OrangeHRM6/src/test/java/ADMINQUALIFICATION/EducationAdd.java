...
public class EducationAdd
{
	...
	public  void EducationAdd(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )
	throws Exception
	{  
			  this.driver=driver;
	...
	{  
		  ...
		  int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet1");
				 ...
				 {	
					 ...
					 UserName=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet1",i,0);
					 Password=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet1",i,1);
					 Name=eat.getCellData("C://HTML Report//OrangeHRM6//TC03_Education.xls","Sheet1",i,2);
	...
	{  
		...
		HtmlOutputFileName=TH3.CretaeHTMLFile("TC03_Education" + str,"Chrome");
		...
		AE.EducationAdd(driver, HtmlOutputFileName, TH3);
		AE.Education(iRow, Name);
	...
	public   void Education(int iRow,String Name)throws Exception
	{  
		...
		driver.findElement(By.xpath(OR.AB_EducationAdd_click)).click(); 
		TH3.HTMLScreenShot("Job focus highlight","Job focused Succefully ",
				"Pass", HtmlOutputFileName,driver);
		driver.findElement(By.xpath(OR.AB_Level_Send)).sendKeys(Name);
		driver.findElement(By.xpath(OR.AB_Save_Click)).click();			 
	}
