...
public class ExportEmployees
{
	...
	{  
			 ...
			 int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC01.xls","Sheet1");

				 for(int i=1;i<2;i++)
				 {		 
					 UserName=eat.getCellData("C://HTML Report//OrangeHRM6//TC01.xls","Sheet1",i,0);
					 Password=eat.getCellData("C://HTML Report//OrangeHRM6//TC01.xls","Sheet1",i,1);
					 iRow=i;
								    	  ...
								    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
								    	   {
								    	      ...
								    	      //  System.out.println("Cell Text Value is: " + valueIneed1);
								    	        ...
								    	        if (valueIneed1 !=null)
								    	        {
								    	          ...
								    	          eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01.xls","Sheet2",i,k,valueIneed1);
								    	        }
								    	        else
								    	        {
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01.xls","Sheet2",i,k,"Blank Data");
								    	        }
								    	   }
								    }
